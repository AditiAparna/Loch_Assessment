...
const TestimonialCard = ({ name, role, message }) => {
  return (
    <div className="bg-[#FAFAFA] border border-gray-200 rounded-xl p-4 transition-transform duration-300 hover:scale-[1.02] text-left h-auto md:h-[140px] flex-shrink-0 w-fit max-w-[400px] mr-4">
